...
class CardItem {
  constructor(data) {
    ...
    this.$iconEdit.setAttribute(
      "class",
      "text-[20px] hover:text-[#ffd852] transition duration-100ms ease-in cursor-pointer pointer-events-none"
    );
    ...
    this.$iconDelete.setAttribute(
      "class",
      "text-[20px] ml-[12px] hover:text-[#ffd852] transition duration-100ms ease-in cursor-pointer pointer-events-none"
    );
  }
