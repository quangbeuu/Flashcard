class SectionItem {
  constructor() {
    ...
    this.$sectionParagraph.innerText = "Making paper flashcards is a time-consuming exercise that, in
    the end, will be more oriented on the textual part rather than
    on the visual one. Also, using a standard set of supplied
    flashcards will likely not fit the personal ways students learn.";
  }
