class ClassIcon {
  constructor(iconName) {
    ...
    this.$classIcon = document.createElement("ion-icon");
    this.$classIcon.setAttribute("name", `${iconName}`);
  }

  render() {
    this.$classIconWrap.appendChild(this.$classIcon);
    return this.$classIconWrap;
  }
}
