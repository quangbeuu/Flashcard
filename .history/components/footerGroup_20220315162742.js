...
class Footer {
  ...
  render() {
    ...
    this.$footerSocial.appendChild(this.$facebook);
    this.$footerSocial.appendChild(this.$twitter);
    this.$footerSocial.appendChild(this.$youtube);
    this.$footerSocial.appendChild(this.$instagram);
