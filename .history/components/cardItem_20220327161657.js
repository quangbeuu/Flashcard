class CardItem {
  constructor(data) {
    ...
    this.$cardWrap.setAttribute(
      "class",
      "flex shadow-card p-[16px] justify-evenly items-center mb-[18px]"
    );
    ...
    this.$img.setAttribute("class", "h-[100px] ");

    this.$cardIconWrap = document.createElement("div");
    this.$cardIconWrap.setAttribute("class", "flex justify-self-end");
