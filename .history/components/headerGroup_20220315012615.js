...
class Header {
  constructor() {
    ...
    this.$buttonCreate = new ButtonGroup("Create", "#8fb397");
    this.$buttonCreate.classList.add("text-white");

    // Right
    this.$headerRight = document.createElement("div");
    this.$headerRight.setAttribute("class", "text-[#2e3856]");

    this.$buttonLogIn = new ButtonGroup("Log in", "white");
    this.$buttonSignUp = new ButtonGroup("Sign up", "#ffcd1f");
  }
