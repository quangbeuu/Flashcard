...
class Header {
  constructor() {
    ...
    this.$userModalContainer.setAttribute(
      "class",
      "absolute bg-white right-0 shadow-card rounded-[8px] w-[200px]  overflow-hidden"
    );
    ...
    this.$userProfile.setAttribute("class", "px-5 py-[12px] hover:text-[]");
    this.$userSettings = document.createElement("div");
    this.$userSettings.innerText = "Settings";
    this.$userSettings.setAttribute("class", "px-5 py-[12px] hover:text-[]");
    this.$logout = document.createElement("div");
    this.$logout.innerText = "Log out";
    this.$logout.setAttribute("class", "px-5 py-[12px] hover:text-[]");
