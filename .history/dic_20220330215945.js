class Dic {
  constructor() {
    ...
    this.$searchBox.setAttribute("class", "w-full felx justify-between");
    ...
    this.$inputWord.setAttribute(
      "class",
      "p-[5px] w-[70%] text-[16px] outline-none border-b-[3px] solid border-b-[#ae8dc3]"
    );
    ...
    this.$searchBtn.setAttribute(
      "class",
      "py-[15px] px-0 w-[25%] bg-[#ae8dc3] border-none outline-none text-white rounded-[5px]"
    );
