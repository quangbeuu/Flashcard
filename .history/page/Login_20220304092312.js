class Login {
  constructor() {
    ...
    this.$loginRightHeader.setAttribute("class", "Log in to Flashcard");
    ...
    this.$loginRightSubTitle.innerText = "Welcome back! login with your data that you entered during
    registration";
  }
  render() {
    // Left
