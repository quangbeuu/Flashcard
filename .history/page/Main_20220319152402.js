...
class Main {
  constructor() {
    ...
    this.$header.$buttonCreate.$buttonCreate.addEventListener("click", this.showModal)
    ...
    this.$modalContainer.setAttribute(
      "class",
      "fixed w-full h-full bg-[rgba(0,0,0,0.25)] z-50 flex justify-center items-center hidden"
    );
