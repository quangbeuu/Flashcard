...
class CreateSet {
  constructor() {
    ...
    this.$wordListHeader.innerText = "Terms in this set (1)";
    this.$wordListSubHeader = document.createElement("h2");
    this.$wordListSubHeader.setAttribute(
      "class",
      "text-[16px] https://docs.google.com/document/d/1j2PHtvfW2UbLWr8D8miijl5u-1HiSSf3ipjMjkfRP60/edit?usp=sharing"
    );
