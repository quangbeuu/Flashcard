...
class Main {
  constructor() {
    ...
    this.$modalContainer.setAttribute(
      "class",
      "fixed w-full h-full bg-[rgba(0,0,0,0.25)] z-50 flex justify-center items-center invisible opacity-0 transition ease-in duration-100"
    );
    ...
    this.$modalDescriptionInput.placeholder = "Enter a class name";
    ...
    this.$modalCreateButton.setAttribute(
      "class",
      "p-6 bg-[#8fb397] w-full text-[18px] font-bold text-white"
    );
  ...
  showModal = (e) => {
    ...
    this.$modalContainer.setAttribute(
      "class",
      "fixed w-full h-full bg-[rgba(0,0,0,0.25)] z-50 flex justify-center items-center visible opacity-100 transition ease-in duration-300"
    );
  };
  ...
  hideModal = (e) => {
    ...
    this.$modalContainer.setAttribute(
      "class",
      "fixed w-full h-full bg-[rgba(0,0,0,0.25)] z-50 flex justify-center items-center invisible opacity-0 transition ease-in duration-300"
    );
  };
