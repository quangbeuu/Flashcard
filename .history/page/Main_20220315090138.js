...
class Main {
  constructor() {
    ...
    this.$posterMainTitle.setAttribute("text-[44px] font-bold mb-[16px]");
    ...
    this.$posterSubTitle.innerText = "With our ever-effective flashcards, eye-catching mindmap
    system, get a suite of science-backed study tools at your
    fingertips.";
  }
