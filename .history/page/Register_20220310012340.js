...
class Register {
    constructor() {
        ...
        this.$registerLeft.setAttribute("class", "w-[50%] bg-[#374355] pt-[55px] pb-[72px] px-[20px]");

        this.$registerLeftHeader = document.createElement("div");
        this.$registerLeftHeader.setAttribute("class", "f-calistoga ml-[72px] mb-[20px] text-white");
        this.$registerLeftHeader.innerText = "Flashcard";

        this.$registerLeftSubTitle = document.createElement("div");
        this.$registerLeftSubTitle.setAttribute("class", "text-white ml-[72px] text-2xl mb-[20px]");
        ...
        this.$registerLeftImage.src = "./assets/img/login-image.png";
        ...
        this.$registerRight.setAttribute("class", "w-[50%] px-[120px] pt-[80px] pb-[40px]");

        this.$registerRightHeader = document.createElement("div");
        this.$registerRightHeader.setAttribute("class", "f-calistoga mb-[20px] text-[#3a3a3a] text-center");
        this.$registerRightHeader.innerText = "Sign up to Flashcard";

        this.$registerRightSubTitle = document.createElement("div");
        this.$registerRightSubTitle.setAttribute("class","text-xl text-[#6e6e6e] mb-[28px] flex justify-center");
        this.$registerRightSubTitle.innerText = "Welcome to Flashcard";

        //inputRegister
        this.$email = new InputLogin("Email", "email", "Enter your email");

        this.$eyeicon = document.createElement("ion-icon");
        this.$eyeicon.setAttribute("name", "eye");
        this.$eyeicon.setAttribute("class","w-[30px] h-[52px] float-left cursor-pointer");
        ...
        this.$confirmPassword = new InputLogin(
            "Confirm Password",
            "password",
        ...
        this.$buttonSubmit.setAttribute("class","px-[15px] py-[10px] bg-[#ff805d] color-white block w-full text-white text-lg uppercase mt-[20px] rounded-md mb-[30px]");
        this.$buttonSubmit.innerText = "Sign up";

        this.$goToLogin = document.createElement("span");
        this.$goToLogin.setAttribute("class", "text-center text-lg flex justify-center cursor-pointer");
