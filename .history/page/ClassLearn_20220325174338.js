...
class ClassLearn {
  constructor(data) {
    ...
    this.$createSetButtonWrap.setAttribute("class", "flex items-center");
    ...
    this.$createSetButton.setAttribute(
      "class",
      "text-[16px] font-bold text-center tracking-[1px] cursor-pointer hover:text-[#ffcd1f] transition ease-in duration-100ms border-b-[1px] border-black"
    );
    this.getDocById();
  }
  // Add a set
