...
class ClassLearn {
  constructor(data) {
    ...
    this.$createSetButton.setAttribute(
      "class",
      "text-[16px] font-bold text-center block tracking-[1px] cursor-pointer hover:text-[#ffcd1f] transition ease-in duration-100ms border border-b-[1px] border-black"
    );
    this.getDocById();
  }
  // Add a set
