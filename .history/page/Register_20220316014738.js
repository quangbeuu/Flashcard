...
class Register {
  constructor() {
    ...
    this.$confirmPassword.$inputItem.addEventListener(
      "input",
  ...
  validateConfirmPassword = () => {
    ...
    if (password == confirmPassword) {
      ...
      this.$errorConfirmPassword.$errorContainer.classList.remove("hidden");
      this.$confirmPassword.$inputContainer.classList.add("border-[#ff805d]");
      this.$errorConfirmPassword.$errorContent.innerText =
