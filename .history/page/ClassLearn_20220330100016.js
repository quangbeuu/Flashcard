...
import { gotoCreateSetPage } from "../nháp/gotoCreateSetPage.js";
...
class ClassLearn {
  constructor(classId) {
    ...
    this.$createSetButtonCreate.addEventListener(
      "click",
      this.gotoCreateSetPage
      // this.createSetPage
    );
    this.pushClassIdToCollection();
    this.getDocById();
  }
  // Add a set
  addASet = () => {
  ...
  pushClassIdToCollection() {
    const cardRef = doc(db, "classes", this._classId);
    updateDoc(cardRef, {
