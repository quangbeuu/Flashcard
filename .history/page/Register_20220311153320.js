...
class Register {
  constructor() {
    ...
    this.$registerContainer.setAttribute("class", "w-[100%] flex h-screen");
    ...
    this.$goToLogin.setAttribute(
      "class",
      "text-center text-lg text-[#ff805d] flex justify-center cursor-pointer"
    );
    ...
    this.$login.setAttribute("class", "underline font-medium cursor-pointer");
