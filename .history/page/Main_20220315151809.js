...
class Main {
  constructor() {
    ...
    this.$sliderContainer.innerText = "User reviews!!!";
    ...
    this.$sliderItemContent = document.createElement("div");
    this.$sliderItemContent.setAttribute(
      "class",
      "text-[30px] font-bold quote-custom"
    );
    this.$sliderItemContent.innerText = "Quizlet gives me an easy way to revise, which I can do on the go
    with the Quizlet app!";
  }
  ...
  render() {
    ...
    this.$sliderContainer.appendChild(this.$yellowLine);
