...
class ClassLearn {
  constructor(data) {
    ...
    this.$sets.setAttribute(
      "class",
      "line-green mx-[16px] text-[16px] font-semibold text-[#303545] cursor-pointer hover:text-[#8fb397]"
    );
  ...
  removeMemberWrap = () => {
    this.$studyMemberWrap.classList.toggle("hidden");
    this.$studySetWrap.classList.toggle("hidden");
  };
