...
class Main {
  constructor() {
    ...
    this.$sectionLearn = new SectionItem(
      ...
      "Make learning into a game",
      "Our brain needs to be challenged in order to make learning more
      interesting and, as a consequence, more effective. This is a
      simple, yet powerful, technique and we promise that you will
      enjoy its effectiveness on the day of the exam!"
    );
  }
