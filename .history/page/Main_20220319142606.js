...
class Main {
  constructor() {
    ...
    this.$modalContainer.setAttribute(
      "class",
      "fixed w-full h-full bg-[rgba(0,0,0,0.25)] z-50 flex justify-center items-center"
    );
  ...
  render(container) {
    ...
    this.modalDescriptionContainer.appendChild(this.$modalClassnameInput);
    this.modalDescriptionContainer.appendChild(this.$modalClassnameLine);
    this.modalDescriptionContainer.appendChild(this.$modalClassnameLabel);
