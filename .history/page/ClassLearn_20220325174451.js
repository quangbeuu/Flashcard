...
class ClassLearn {
  constructor(data) {
    ...
    this.$createSetButton.setAttribute(
      "class",
      "text-[16px] font-bold text-center tracking-[1px] cursor-pointer hover:text-[#ffcd1f] transition ease-in duration-100ms border-b-[2px] border-transparent hover:border-[]"
    );
    this.getDocById();
  }
  // Add a set
