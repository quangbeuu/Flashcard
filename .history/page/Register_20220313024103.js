...
class Register {
  constructor() {
    ...
    this.$email.$inputItem.addEventListener("input", this.validatePassword);
  ...
  validateUsername = () => {
    ...
    if (regUsername.test(userName.trim())) {
      this.$errorUsername.$errorContainer.classList.add("hidden");
      this.$username.$loginContainer.classList.remove("border-[#ff805d]");
    } else {
      this.$errorUsername.$errorContainer.classList.remove("hidden");
      this.$username.$loginContainer.classList.add("border-[#ff805d]");
  ...
  validateEmail = () => {
    ...
    if (regexEmail.test(loginEmail.trim())) {
      this.$errorEmail.$errorContainer.classList.add("hidden");
      this.$email.$loginContainer.classList.remove("border-[#ff805d]");
    } else {
  ...
  validatePassword = () => {
    ...
    if (loginPassword.length <= 18 && loginPassword.length >= 8) {
      this.$errorPassword.$errorContainer.classList.add("hidden");
      this.$password.$loginContainer.classList.remove("border-[#ff805d]");
    } else {
      this.$errorPassword.$errorContainer.classList.remove("hidden");
      this.$password.$loginContainer.classList.add("border-[#ff805d]");
