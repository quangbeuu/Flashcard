class Dic {
  constructor() {
    ...
    this.$dicContainer.setAttribute(
      "class",
      "bg-[background-color: rgb(255, 255, 255) h-[90vmin] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] px-[50px] py-[80px] rounded-[10px] shadow-[0 20px 40px rgba(38,33,61,0.2)]"
    );
