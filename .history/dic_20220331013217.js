class Dic {
  constructor() {
    ...
    this.$gotoHomePage.href = "./index.html";
    this.$gotoHomePage.setAttribute("class", "block m-[20px] mt-[40px]");
    this.$gotoHomePageIcon = document.createElement("i");
    this.$gotoHomePageIcon.setAttribute(
      "class",
      "fa fa-arrow-alt-circle-left text-red-400 text-[30px]"
    );
  }
  ...
  render(container) {
    ...
    this.$gotoHomePage.appendChild(this.$gotoHomePageIcon);
    container.appendChild(this.$gotoHomePage);
